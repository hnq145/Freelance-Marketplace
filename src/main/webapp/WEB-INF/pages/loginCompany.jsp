...
<html lang="en">
  <head>
    ...
    />
    <title>Company Login | ProjectPulse+</title>
    <link
  ...
  <body>
    <div class="glass-panel login-card">
      <div class="text-center mb-5">
        ...
        <h5 class="text-white mt-2">Company Portal</h5>
      </div>
      ...
      <form action="processLoginCompany" method="post">
        ...
        <div class="text-center mt-3">
          <a href="registerCompany" class="small text-muted"
